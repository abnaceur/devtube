...
/*
** [POST] Route:"dashboard/chatbot/:userId" [USED]
*/
router.post('/chatbot/:userId', authCkeck, checkUser.checkUserRole, dashboardController.addChatbotDash);

/*
** [GET] Route:"dashboard/chatbot/list/:userId/:page" [USED]
*/
router.get('/chatbot/list/:userId/:page', authCkeck, checkUser.checkUserRole, dashboardController.getChatbotDash);

/*
** [PUT] Route:"dashboard/chatbot/del/:userId" [USED]
*/
router.put('/chatbot/del/:userId', authCkeck, checkUser.checkUserRole, dashboardController.delChatbotDash);

/*
** [PUT] Route:"dashboard/chatbot/edit/:userId" [USED]
*/
router.put('/chatbot/edit/:userId', authCkeck, checkUser.checkUserRole, dashboardController.editChatbotDash);

/*
** [GET] Route:"dashboard/chatbot/trainig/:userId" [USED]
*/
router.get('/chatbot/trainig/:userId', authCkeck, checkUser.checkUserRole, dashboardController.trainingChatbotDash);
