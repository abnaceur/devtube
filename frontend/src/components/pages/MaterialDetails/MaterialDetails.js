...
class MaterialDetails extends React.Component {
  ...
  transform(dateValue) {
    moment.locale("fr");
    let a = moment().locale('fr').format('ll', dateValue)
    return a;
  }
                ...
                <div className="col-md-12">
                  <div className="box box-primary" id="fixMarginTop">
                    <div className="box-header with-border">
                      <h3 className="box-title">Les détails</h3>
                              ...
                              <div className="panel-body">
                                <div className="row">
                                  <div className="textbox">
                                    <h4><b>Uploader par </b>
                                      ...
                                      {this.state.materialDetails
                                        ? this.transform(this.state.materialDetails.dateOfCreation)
                                        : ""}
                                    </h4>{" "}
                                  </div>
                                  <br></br>
                                  <div className="textbox">
                                    ...
                                    <ScrollView onEndReached={this.handleEndReached} style={{ height: '50vh' }}>
