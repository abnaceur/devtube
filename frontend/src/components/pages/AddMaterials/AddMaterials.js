...
class AddMaterials extends React.Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (this.state.progressBarPerc === 100) {
                                ...
                                <div className="row" >
                                    <div className="box box-primary">
                                        <div className="box-header with-border">
                                            <h3 className="box-title">Ajouter des ressources</h3>
                                        </div>
                                        <form method="post" onSubmit={this.handlFormSubmit} encType="multipart/form-data">
                                            <div className="box-body">
                                                ...
                                                <div className="form-group col-md-12">
                                                    ...
                                                    <p className="help-block col-md-7">Seulement les formats JPEG/PNG seront acceptés.</p>
                                                </div>
                                                <div className="form-group files col-md-5">
                                                    <label>Uploadé des videos</label>
                                                    <input type="file" name="videos" onChange={this.handleVideoChange} multiple />

                                                    <p className="help-block">Seulement les format MP4 sera acceptés.</p>
                                                </div>
